...
class ProfileRiderFix extends StatefulWidget {
  const ProfileRiderFix({super.key});

  @override
  State<ProfileRiderFix> createState() => _ProfileRiderFixState();
}

class _ProfileRiderFixState extends State<ProfileRiderFix> {
  File? _profileImage;
  File? _vehicleImage;
